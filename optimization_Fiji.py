...
# flood north
#network = r'./input/north_flood/fj_roads_north_FRA_v5.shp'
#centroid = r'./input/fiji_north/OD_north_9cities.shp'
#dbf = Dbf5(r'./input/north_flood/fj_bridges_north_FRA_v3.dbf')

##typhoon north
#network = r'./input/north_typhoon/fj_roads_north_FRA_v11.shp'
#centroid = r'./input/fiji_north/OD_north_9cities.shp'
#dbf = Dbf5(r'./input/north_typhoon/fj_bridges_north_FRA_v1.dbf')

# flood south
network = r'./input/fiji_south/fj_roads_south_FRA_v5.shp'
centroid = r'./input/fiji_south/OD_south_10Cities.shp'
dbf = Dbf5(r'./input/fiji_south/fj_bridges_south_FRA_v2.dbf')
...
#    realBenefit.append(realValue[0][1] - realValue[i][1])    
#
# In[]
...
## In[]
## plot 
#budget= list(range(0, 200, 20))
#plt.plot(budget,realBenefit,'bo-')        
#plt.xlabel('Budget (Million $)')     
#plt.ylabel('Annual Social Economic Saving (Billion $)') 
#
#
